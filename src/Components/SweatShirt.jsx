                ...
                <div className="grid grid-cols-2 gap-4">
                  {logos && logos.map((logo) => (
                    <button
                      ...
                      className="group flex flex-col items-center p-4 border border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50/50 hover:shadow-md transition-all duration-200"
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {countries.map((country) => (
                    <button
                      ...
                      className="flex flex-col items-center gap-2 p-3 border border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50/50 hover:shadow-sm transition-all duration-200 text-center"
                    >
                      <img
                        src={country.flag}
                        alt={country.name}
                        className="w-10 h-auto shadow-sm rounded-sm"
                      />
