  ...
  const getDiffuseBase64 = async (
    ...
    if (logoSrc) {
      try {
        ...
        // No solid white background box — let cloth color through
    ...
    ["preview-iframe", "preview-iframe2"].forEach(id => {
      ...
      if (color === "light") {
        ...
        if (opacityB64) invertOpacity(opacityB64, inv => {
          iframe.contentWindow.postMessage("Hoodie:back_white_diffuse: " + inv, "*");
        });
        if (opacityB64) invertOpacity(opacityB64, inv => {
          iframe.contentWindow.postMessage("Hoodie:back_white_opacity: " + inv, "*");
        });
      }
    });
  };
