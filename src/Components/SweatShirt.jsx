...
const SweatShirt = ({ data, onUpdate, isAppReady, logos, backDesigns, maxCharsText = 25, activeTab: externalTab }) => {
      ...
      formatTexture(opacityB64, (formattedOpacity) => {
        ["preview-iframe", "preview-iframe2"].forEach(id => {
          ...
          if (color === "light") {
            ...
            if (formattedDiffuse) iframe.contentWindow.postMessage("SweatShirt:back_white_diffuse: " + formattedDiffuse, "*");
  ...
  return (
    <div className="max-w-md mx-auto">
      {activeTab === "size" ? (
        <>
          <h1 className="lg:text-lg text-md lg:font-bold font-semibold lg:mb-3 mb-1 text-gray-900">SweatShirt</h1>
        ...
        <>
          ...
          <div className="lg:mb-6">
            ...
            {["rightChest", "leftChest"].map((area) => (
              <div key={area} className="bg-white rounded-lg lg:p-4 p-2 lg:mb-4 mb-2">
                <h3 className=" lg:font-semibold text-gray-900 lg:mb-3 mb-1">{area === "rightChest" ? "Right Chest:" : "Left Chest:"}</h3>
          ...
          <div className="lg:mb-6">
            <h2 className="lg:text-xl text-base font-semibold text-gray-900 lg:mb-4 mb-2">Sleeve Area</h2>
            {["rightSleeve", "leftSleeve"].map((area) => (
              <div key={area} className="bg-white rounded-lg lg:p-4 p-2 lg:mb-4 mb-2">
                <h3 className=" lg:font-semibold text-gray-900 lg:mb-3 mb-1">{area === "rightSleeve" ? "Right Sleeve:" : "Left Sleeve:"}</h3>
                <div className="space-y-3">
                  <div className="flex rounded-lg overflow-hidden border border-gray-200">
                    {["text", "flag", "logo"].map((tab) => (
                      <button key={tab} type="button"
